...
set -e
cd "$(dirname "$0")"
cc -O2 -Wall -Wextra -DPICO_NO_HARDWARE -I../src -o /tmp/tecla_host_test host_test.c ../src/scales.c ../src/truchet_patterns.c ../src/edge_detect.c ../src/drumsynth.c -lm
exec /tmp/tecla_host_test
